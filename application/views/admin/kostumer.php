...
<a href="<?php echo base_url() . 'admin/kostumer_add'; ?>" class="btn btn-sm btn-primary"><span
        class='glyphicon glyphicon-plus'></span> Kostumer Baru</a>
<br />
<br />
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-warning"
                            href="<?php echo base_url() . 'admin/kostumer_edit/' . $k->kostumer_id; ?>"><span
                                class="glyphicon glyphicon-wrench"></span> Edit</a>
                        <a class="btn btn-sm btn-danger"
                            href="<?php echo base_url() . 'admin/kostumer_hapus/' . $k->kostumer_id; ?>"><span
